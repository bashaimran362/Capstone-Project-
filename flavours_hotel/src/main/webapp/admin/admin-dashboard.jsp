...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container-fluid container">
      ...
      <a class="navbar-brand pl-3" href="#">FLAVOURS HOTEL</a>
      <button
    ...
    <div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="javascript:addReceptionistForm.submit()">Add Receptionist</a>
                    
                </li>
                <li>
                    <a href="javascript:addCustomerForm.submit()">Add Customer</a>
                </li>
                <li>
                    <a href="javascript:document.addNewServicesForm.submit()">Add Services</a>
                </li>
                <li>
                ...
                <li>
                    <a href="javascript:document.showAllCustomersForm.submit()">Show All Customers</a>
                </li>
                <li>
                    <a href="javascript:document.showAllReceptionistsForm.submit()">Show All Receptionists</a>
                </li>
            ...
            <div class="d-md-flex justify-content-center pb-5">
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card bg-danger order-card">
                  ...
                  <form name="addCustomerForm" action="/admin/addCustomer" hidden="true" method="get">
      				<input hidden type="submit" value="/admin/addCustomer"/></form>
                </div>
              </div>
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card bg-success order-card">
                  ...
                  <form name="bookingInfoForm" action="/admin/bookingInfo" hidden="true" method="get">
      				<input hidden type="submit" value="/admin/bookingInfo"/></form>
                </div>
              </div>
            ...
            <div class="d-md-flex justify-content-center pb-5">
              ...
              <div class="col-md-4 col-xl-4">
                <div class="card bg-secondary order-card">
                  ...
                  <a class="btn btn-secondary text-dark" href="javascript:document.addNewServicesForm.submit()" role="button"><h3>Add New Services</h3></a>
                  <form name="addNewServicesForm" action="/admin/addNewServices" hidden="true" method="get">
      				<input hidden type="submit" value="/admin/addNewServices"/></form>
                </div>
              </div>
